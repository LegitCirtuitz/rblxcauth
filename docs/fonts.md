!!! danger
    This page contains information about client code. Be careful when modifying Client Code!

### Fonts
!!! warning
    This Preloads all Fonts in Roblox's Default Font Family. 
Here are the list of fonts Preloaded by CAuth and their ``rbxasset`` path.
...
- **Migae**: `rbxasset://fonts/families/Migae.json`
